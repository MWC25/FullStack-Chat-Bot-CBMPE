...
export default function Profile() {
    ...
    return (
        <div className="flex flex-col justify-center gap-16 px-32 py-8">
            <h3 className="title-3 uppercase bold">Perfil do usuário</h3>
            <div className="flex flex-row justify-evenly w-full h-full">
                ...
                <div>
                    ...
                    <SettingRow
                        sectionName="Linguagem"
                        sectionData="português"
                    />
                </div>
                <button className="flex flex-col items-start cursor-pointer w-200">
